...
The infrastructure deployment and mantainence is fully automated using [Terraform](https://www.terraform.io/[Terraform]). 

Some manual steps are listed bellow, mostly they are related more to presentation than functionality.

== Cognito Custom Domain

1. Create (and validate) certificate for the custom domain [here](https://us-east-1.console.aws.amazon.com/acm/home);
